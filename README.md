...
This guide explains Cloud Foundry User Account and Authentication (UAA). UAA is the identity management and authorization server for Cloud Foundry.

This is a content repository in the [Cloud Foundry documentation set](https://github.com/cloudfoundry/docs-book-cloudfoundry).

## Published location

This content is published at https://docs.cloudfoundry.org/uaa/.
